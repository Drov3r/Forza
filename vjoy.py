...
def setCar(turn, accel, brak):
    wAxisX = 16000 + int(turn * 16000.0)
    wSlider = int(accel * 32000.0)
    wDial = int(brak * 32000.0)
    joystickPosition = vj.generateJoystickPosition(wAxisX=wAxisX, wSlider=wSlider, wDial=wDial)
    vj.update(joystickPosition)
